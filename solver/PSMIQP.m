function [solution_x,solution_t,exitflag] = PSMIQP(n,m,p,q,Aineq,bineq,Aeq,beq,lb,ub,Qfun,qfun,cfun,Qcon,qcon,ccon,x_start,a,r)
...
% Write model
gurobi_write(model, 'solver/PSMIQP.lp');
